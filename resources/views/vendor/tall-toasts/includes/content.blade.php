<div
    ...
    x-bind:class="{
                    'border-blue-700 bg-neutral-700': toast.type === 'info',
                    'border-green-700 bg-neutral-700': toast.type === 'success',
                    'border-yellow-700 bg-neutral-700': toast.type === 'warning',
                    'border-red-700 bg-neutral-700': toast.type === 'danger'
                  }"
>
